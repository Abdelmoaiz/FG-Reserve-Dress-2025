...
const expensesOthers = new Datastore({filename:'db/myExpensesOthers.db', autoload:true})
...
const history = new Datastore({filename:'db/myHistory.db', autoload:true})
...
ipcMain.on('myExpensesOthers',(e, myExpensesOthers)=>{
  expensesOthers.insert({'myExpensesOthers':myExpensesOthers}) 
});

ipcMain.on('get-expensesOthers',(e,arg)=>{
  expensesOthers.find({},(e,allExpensesOthers)=>{
    ipcMain.on('get-expensesOthers', (e,da)=>{
      e.sender.send('get-expensesOthers', JSON.stringify(allExpensesOthers))

    })
  })
})

ipcMain.on('update-expensesOthers',(e,myExpensesOthers)=>{
  expensesOthers.update({_id:myExpensesOthers.tmp},{"myExpensesOthers":myExpensesOthers})
})


ipcMain.on('delete-expensesOthers',(e,args)=>{
  expensesOthers.remove({_id:args},{},(e,dataRemove)=>{
  })
})
...
ipcMain.on('myHistory',(e, mydataPro)=>{
  history.insert(mydataPro)
});

ipcMain.on('get-history',(e,arg)=>{

  history.find({},(e,args)=>{
    ipcMain.on('get-history', (e,da)=>{
      e.sender.send('get-history', JSON.stringify(args))
    })
  })
})

ipcMain.on('update-history',(e,args)=>{
  history.update({_id:args.tmp},{myHistory:args})
})

ipcMain.on('delete-history',(e,args)=>{
  history.remove({_id:args},{},(e,dataRemove)=>{
  })
})
